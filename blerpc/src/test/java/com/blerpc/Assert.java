...
/**
 * A set of methods that assert conditions and return error when an condition is wrong. Methods of
 * this class based on JUnit5 assertion methods that can't be used in Android with Android Gradle
