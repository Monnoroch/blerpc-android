...
/** Tests for {@link SwiftMessageParserGenerator}. */
@RunWith(JUnit4.class)
public class SwiftMessageParserGeneratorTest {
  ...
  SwiftMessageParserGenerator generator;

  /** Set up. */
  @Before
  public void setUp() {
    generator = new SwiftMessageParserGenerator();
  }
  ...
  public void buildServiceContexts_serviceDeprecated() throws Exception {
    PluginProtos.CodeGeneratorRequest request =
        PluginProtos.CodeGeneratorRequest.newBuilder()
            ...
            .build();
    SwiftMessageParserGenerator.MessageContext messageContext = createServiceContext();
    messageContext.deprecated = true;
    assertEquals(generator.buildServiceContexts(request), messageContext);
  }
  ...
  public void buildServiceContexts_methodDeprecated() throws Exception {
    PluginProtos.CodeGeneratorRequest request =
        PluginProtos.CodeGeneratorRequest.newBuilder()
            ...
            .build();
    SwiftMessageParserGenerator.MessageContext messageContext = createServiceContext();
    messageContext.methods.forEach(methodContext -> methodContext.deprecated = true);
    assertEquals(generator.buildServiceContexts(request), messageContext);
  }
  ...
  public void buildServiceContexts_methodWithoutJavaDoc() throws Exception {
    PluginProtos.CodeGeneratorRequest request =
        PluginProtos.CodeGeneratorRequest.newBuilder()
            ...
            .build();
    SwiftMessageParserGenerator.MessageContext messageContext = createServiceContext();
    messageContext.methods.forEach(methodContext -> methodContext.javaDoc = null);
    assertEquals(generator.buildServiceContexts(request), messageContext);
  }
  ...
  public void buildServiceContexts__notMethodLocation_wrongLength() throws Exception {
    PluginProtos.CodeGeneratorRequest request =
        PluginProtos.CodeGeneratorRequest.newBuilder()
            ...
            .build();
    SwiftMessageParserGenerator.MessageContext messageContext = createServiceContext();
    messageContext.methods = ImmutableList.of(createSubscribeMethodContext());
    assertEquals(generator.buildServiceContexts(request), messageContext);
  }
  ...
  private SwiftMessageParserGenerator.MessageContext createServiceContext() {
    SwiftMessageParserGenerator.MessageContext messageContext =
        new SwiftMessageParserGenerator.MessageContext();
    messageContext.serviceName = SERVICE_NAME;
    messageContext.className = RX_CLASS_PREFIX + SERVICE_NAME;
    messageContext.fileName = SERVICE_FILE_NAME;
    messageContext.javaDoc = String.format(SERVICE_JAVADOC_TEMPLATE, SERVICE_JAVADOC);
  ...
  private SwiftMessageParserGenerator.MethodContext createReadMethodContext() {
    SwiftMessageParserGenerator.MethodContext readMethodContext =
        new SwiftMessageParserGenerator.MethodContext();
  ...
  private SwiftMessageParserGenerator.MethodContext createSubscribeMethodContext() {
    SwiftMessageParserGenerator.MethodContext subscribeMethodContext =
        new SwiftMessageParserGenerator.MethodContext();
  ...
  private void assertEquals(
      ImmutableList<SwiftMessageParserGenerator.MessageContext> servicesList,
      SwiftMessageParserGenerator.MessageContext secondService) {
    assertThat(servicesList).hasSize(1);
    assertEquals(servicesList.get(0), secondService);
  }

  private void assertEquals(
      SwiftMessageParserGenerator.MessageContext firstService,
      SwiftMessageParserGenerator.MessageContext secondService) {
  ...
  private void assertEquals(
      SwiftMessageParserGenerator.MethodContext firstMethod,
      SwiftMessageParserGenerator.MethodContext secondMethod) {
